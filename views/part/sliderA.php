        ...
        <div class="admin-left">
            ...
            <div class="anh-nen row">
                ...
                <div class="anh-nen-conten">
                    <p>xin chào</p>
                    <h3><?= htmlspecialchars($admins['userName']) ?></h3>
                </div>
            </div>
            ...
            <div class="quan-ly">
                ...
                <div class="danh-muc">
                    <ul>
                        <li><a href="index.php?controller=admin&action=Admin2">quản lí Admin</a></li>
                        <li><a href="index.php?controller=login&action=createAdmin">tạo tài khoản admin</a></li>
