...
<body>
    <header>
        ...
        <div class="header-content">
            ...
            <form action="index.php?controller=login&action=createUser" method="POST">
                <h1>Đăng Kí Tài Khoản và Trải Ngiệm</h1>
                <p>Tài Khoản</p>
                ...
                <p>Số Điện Thoại</p>
                <input type="number" name="numphone" />
                <p>Địa chỉ cụ thể</p>
    ...
    <p>Đã có tài khoản? <a href="index.php?controller=login&action=index" style="color: #e91e63; font-weight: bold;">Đăng nhập ngay</a></p>
</div>
            </form>
